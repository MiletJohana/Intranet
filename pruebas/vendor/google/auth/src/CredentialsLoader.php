...
abstract class CredentialsLoader implements FetchAuthTokenInterface
{
    ...
    const WELL_KNOWN_PATH = 'gcloud/application_default_token/credentials.json';
     ...
     * - windows: %APPDATA%/gcloud/application_default_token/credentials.json
     * - others: $HOME/.config/gcloud/application_default_token/credentials.json
     *

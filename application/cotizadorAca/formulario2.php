...
<div class="row">
    ...
    <input class="form-control" type="hidden" name="nom_cli3" id="nom_cli3" onkeyup="auto(3);">
...
<form method="POST" id="form-Cliente">
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-sm-12 mb-3">
            ...
            <select class="form-select" id="rep_sac1" name="rep_sac1" required>
                <?php if (!isset($_POST['edit'])) { ?>
    ...
    <div id="infoCont">
        <?php if (isset($_POST['resp']) && $_POST['resp'] != 7) { ?>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-12 mb-3">
                    <label for="apell_cont4" class="form-label">Apellidos</label>
                    <input type="text" class="form-control" id="apell_cont4" name="apell_cont4" placeholder="Nombre Contacto" required>
                </div>
    ...
    <br>
    <div class="col-12 mb-3" id="respuestaClie"></div>
    <div class="row mb-3" id="error2"></div>
</form>
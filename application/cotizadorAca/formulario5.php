...
<form id="form-misDatos" role="form">
    <div class="row">
        ...
        <div class="col-md-3 mb-3">
            <label class="col-12" for="usuario">Usuario:</label>
                <div class="col-12">
                <input type="text" class="form-control" id="usuario" name="usuario"  value="<?php echo $person->usuario; ?>" required>
            </div>
        </div>
        <div class="col-md-3 mb-3">
            <label class="col-12" for="ext_usu">Extensión:</label>
            <div class="col-12">
	...
	<div class="row">
		...
		<div class="col-md-3 mb-3">
            <label class="col-12" for="cns_cotz">Consecutivo:</label>
            <div class="col-12">

...
<div class="col-md-12 pt-2">
    ...
    <div class="row">
        <div class="col-md-2 col-sm-12">
            ...
            <select class="form-control" id="esta" onchange="filtroper('esta,mes','../permisos/tabla3.php')">
        ...
        <div class="col-md-2 col-sm-12">
            <label for="mesHs">Mes</label>
            <input type="month" id="mes" name="mes" value="<?php date('Y-m') ?>" max="" min="" class="form-control"
        ...
        <form action="../permisos/reportes/permisosExcel.php" id="formExp" method="POST" class="mt-2 col-md-2 col-sm-12">
            <div class="dropdown">
                <label for="exp">Exportar a:</label><br>
                ...
                <div class="dropdown-menu dropdown-menu-start">
                    <a class="btn btn-link dropdown-item" href="#1" 
                        onclick="formPerm('<?php $_SESSION['id'];?>','<?php $_SESSION['lid']?>', '<?php $_SESSION['are']?>')">Mes</a>
                </div>
            </div>
        </form>
    </div>

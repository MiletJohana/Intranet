<?php if ($_POST['resp'] == 1) { ?>
    ...
    <button id="cerrar1" class="btn btn-secondary ms-1" data-bs-dismiss="modal" onclick="refreshTable( <?php $_POST['cerrar'] ?>)">Cerrar</button>
<?php } else if ($_POST['resp'] == 2) { ?>
    <button id="btnCliente" class="btn btn-danger" onclick="crearClientec();" disabled>Crear Cliente</button>
    <button id="cerrar2" class="btn btn-secondary ms-1" data-bs-dismiss="modal" onclick="refreshTable(<?php $_POST['cerrar'] ?>)">Cerrar</button>
<?php } else if ($_POST['resp'] == 3) { ?>
    <button id="btnContacto" class="btn btn-danger" onclick="crearContacto();" disabled>Crear Contacto</button>
    <button id="cerrar3" class="btn btn-secondary ms-1" data-bs-dismiss="modal" onclick="refreshTable(php $_POST['cerrar'] ?>)">Cerrar</button>
<?php } else if ($_POST['resp'] == 4) { ?>
    <button id="btnProducto" class="btn btn-danger" onclick="crearProducto();" disabled>Crear Producto</button>
    <button id="cerrar4" class="btn btn-secondary ms-1" data-bs-dismiss="modal" onclick="refreshTable(<?php $_POST['cerrar'] ?>)">Cerrar</button>
<?php } else if ($_POST['resp'] == 5) { ?>
    ...
    <button id="cerrar5" class="btn btn-secondary ms-1" data-bs-dismiss="modal" onclick="refreshTable(<?php $_POST['cerrar'] ?>)">Cerrar</button>
<?php } else if ($_POST['resp'] == 6) { ?>
    ...
    <button id="cerrar7" class="btn btn-secondary ms-1" data-bs-dismiss="modal" onclick="refreshTable(<?php $_POST['cerrar'] ?>)">Cerrar</button>
...
<?php } else if ($_POST['resp'] == 8) { ?>
    ...
    <button id="cerrar8" class="btn btn-secondary ms-1" data-bs-dismiss="modal" onclick="refreshTable(<?php $_POST['cerrar'] ?>)">Cerrar</button>
<?php } else if ($_POST['resp'] == 9) { ?>
    <button id="btnProducto" class="btn btn-danger" onclick="actualizarProd();">Actualizar Producto</button>
    <button id="cerrar9" class="btn btn-secondary ms-1" data-bs-dismiss="modal" onclick="refreshTable(<?php $_POST['cerrar'] ?>)">Cerrar</button>
...
<?php } else if ($_POST['resp'] == 11) { ?>
    ...
    <button id="cerrar7" class="btn btn-secondary ms-1" data-bs-dismiss="modal" onclick="refreshTable(<?php['cerrar'] ?>)">Cerrar</button>
<?php } else if ($_POST['resp'] == 12) { ?>
    <button id="btnClienteElim" class="btn btn-danger" onclick="eliminar(12,<?php $_POST['elim'] ?>,'elimClie',2);">Eliminar</button>
    <button id="" class="btn btn-secondary ms-1" data-bs-dismiss="modal">Cerrar</button>
<?php } else if ($_POST['resp'] == 13) { ?>
    <button id="btnClienteElim" class="btn btn-danger" onclick="eliminar(13,<?php $_POST['elim'] ?>,'elimCont',2);">Eliminar</button>
    <button id="" class="btn btn-secondary ms-1" data-bs-dismiss="modal">Cerrar</button>
<?php } else if ($_POST['resp'] == 14) { ?>
    <button id="btnClienteElim" class="btn btn-danger" onclick="eliminar(14,<?php $_POST['elim'] ?>,'elimProd',2);">Eliminar</button>
    <button id="" class="btn btn-secondary ms-1" data-bs-dismiss="modal">Cerrar</button>
<?php } else if ($_POST['resp'] == 15) { ?>
    <button id="btnDatos" class="btn btn-danger" onclick="subirCoti(<?php $_POST['id_usu'] ?>);">Subir Cotización</button>
    <button id="cerrar5" class="btn btn-secondary ms-1" data-bs-dismiss="modal" onclick="refreshTable(<?php $_POST['cerrar'] ?>)">Cerrar</button>

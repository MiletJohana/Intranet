...
$sql = "SELECT COUNT(id_coti),est_cot , monthname(fec_coti), month(fec_coti)
...
function totalApr($conexion, $id, $month, $anio)
{
	...
	$sql = "SELECT SUM(prec_cot) as total, grup_car
		  from cot_cotizaciones cot, mq_usu us
		  where cot.id_usu=us.id_usu
		  AND est_cot='2'";
	if ($id == '100') {
...
function sinActu($conexion, $id, $month, $anio)
{
	$sql = "SELECT COUNT(est_cot) as est, grup_car 
				FROM `cot_cotizaciones` cot,`mq_usu` us 
				WHERE  cot.id_usu=us.id_usu 
				AND `est_cot`='0' AND `sol_cot`='0'";
	if ($id == '100') {
		$sql .= " AND grup_car IN(18)";
	} elseif ($id == '200') {
		$sql .= " AND grup_car IN(19)";
...
<div class="table-responsive">
	<table class="table table-bordered table-hover" id="datatable">
		<thead class="table-dark">
			...
			<?php if ($month == 1) { ?>
				<th><a target="blank" href="index.php?cot=1&id=<?php echo $id . '&mes=' . $anio . '-01&mes2=' . $anio . '-01'; ?>">ENE</a></th>
			<?php }
			if ($month == 1 || $month == 2) { ?>
				<th><a target="blank" href="index.php?cot=1&id=<?php echo $id . '&mes=' . $anio . '-02&mes2=' . $anio . '-02'; ?>">FEB</a></th>
			<?php }
			if ($month == 1 || $month == 2 || $month == 3) { ?>
				<th><a target="blank" href="index.php?cot=1&id=<?php echo $id . '&mes=' . $anio . '-03&mes2=' . $anio . '-03'; ?>">MAR</a></th>
			...
			if (($month == 1 || $month == 2 || $month == 3 || $month == 4) && ($mes2 == 4 || $mes2 == 5 || $mes2 == 6 || $mes2 == 7 || $mes2 == 8 || $mes2 == 9 || $mes2 == 10 || $mes2 == 11 || $mes2 == 12)) { ?>
				<th><a target="blank" href="index.php?cot=1&id=<?php echo $id . '&mes=' . $anio . '-04&mes2=' . $anio . '-04'; ?>">ABR</a></th>
			<?php }
			if (($month == 1 || $month == 2 || $month == 3 || $month == 4 || $month == 5) && ($mes2 == 5 || $mes2 == 6 || $mes2 == 7 || $mes2 == 8 || $mes2 == 9 || $mes2 == 10 || $mes2 == 11 || $mes2 == 12)) { ?>
				<th><a target="blank" href="index.php?cot=1&id=<?php echo $id . '&mes=' . $anio . '-05&mes2=' . $anio . '-05'; ?>">MAY</a></th>
			<?php }
			if (($month == 1 || $month == 2 || $month == 3 || $month == 4 || $month == 5 || $month == 6) && ($mes2 == 6 || $mes2 == 7 || $mes2 == 8 || $mes2 == 9 || $mes2 == 10 || $mes2 == 11 || $mes2 == 12)) { ?>
				<th><a target="blank" href="index.php?cot=1&id=<?php echo $id . '&mes=' . $anio . '-06&mes2=' . $anio . '-06'; ?>">JUN</a></th>
			...
			if (($month == 1 || $month == 2 || $month == 3 || $month == 4 || $month == 5 || $month == 6  || $month == 7) && ($mes2 == 7 || $mes2 == 8 || $mes2 == 9 || $mes2 == 10 || $mes2 == 11 || $mes2 == 12)) { ?>
				<th><a target="blank" href="index.php?cot=1&id=<?php echo $id . '&mes=' . $anio . '-07&mes2=' . $anio . '-07'; ?>">JUL</a></th>
			<?php }
			if (($month == 1 || $month == 2 || $month == 3 || $month == 4 || $month == 5 || $month == 6  || $month == 7 || $month == 8) && ($mes2 == 8 || $mes2 == 9 || $mes2 == 10 || $mes2 == 11 || $mes2 == 12)) { ?>
				<TH><a target="blank" href="index.php?cot=1&id=<?php echo $id . '&mes=' . $anio . '-08&mes2=' . $anio . '-08'; ?>">AGO</a></TH>
			<?php }
			if (($month == 1 || $month == 2 || $month == 3 || $month == 4 || $month == 5 || $month == 6  || $month == 7 || $month == 8 || $month == 9) && ($mes2 == 9 || $mes2 == 10 || $mes2 == 11 || $mes2 == 12)) { ?>
				<th><a target="blank" href="index.php?cot=1&id=<?php echo $id . '&mes=' . $anio . '-09&mes2=' . $anio . '-09'; ?>">SEP</a></th>
				<th class="bg-danger">TOTAL<br>3Q</th>
			<?php }
			if ($mes2 == 10 || $mes2 == 11 || $mes2 == 12) { ?>
				<th><a target="blank" href="index.php?cot=1&id=<?php echo $id . '&mes=' . $anio . '-10&mes2=' . $anio . '-10'; ?>">OCT</a></th>
				<?php if ($mes2 == 11 || $mes2 == 12) { ?>
					<th><a target="blank" href="index.php?cot=1&id=<?php echo $id . '&mes=' . $anio . '-11&mes2=' . $anio . '-11'; ?>">NOV</a></th>
				<?php }
				if ($mes2 == 12) { ?>
					<th><a target="blank" href="index.php?cot=1&id=<?php echo $id . '&mes=' . $anio . '-12&mes2=' . $anio . '-12'; ?>">DIC</a></th>
				<?php } ?>
		...
		<tbody class="text-center">
			<tr>
				<td class="bg-success" colspan="2">Aprobado</td>
				<?php if ($month == 1) { ?>
			...
			<tr>
				<td class="bg-warning" colspan="2">Pendiente</td>
				<?php if ($month == 1) { ?>
			...
			<tr>
				<td class="bg-info" colspan="2">Act de precios</td>
				<?php if ($month == 1) { ?>
			...
			<tr>
				<td class="bg-danger" colspan="2">Rechazado</td>
				<?php if ($month == 1) { ?>
			...
			<tr>
				<td class="" colspan="2">Sin Actualizar</td>
				<?php if ($month == 1) { ?>
					<td><a target="blank" target="blank" href="index.php?cot=1&id=<?php echo $id . '&mes=' . $anio . '-01&mes2=' . $anio . '-01'; ?>&est=0&sol=NULL"><?php echo sinActu($conexion, $id, 1, $anio); ?></a></td>
				<?php }
				if ($month == 1 || $month == 2) { ?>
					<td><a target="blank" target="blank" href="index.php?cot=1&id=<?php echo $id . '&mes=' . $anio . '-02&mes2=' . $anio . '-02'; ?>&est=0&sol=NULL"><?php echo sinActu($conexion, $id, 2, $anio); ?></a></td>
				<?php }
				if ($month == 1 || $month == 2 || $month == 3) { ?>
					<td><a target="blank" target="blank" href="index.php?cot=1&id=<?php echo $id . '&mes=' . $anio . '-03&mes2=' . $anio . '-03'; ?>&est=0&sol=NULL"><?php echo sinActu($conexion, $id, 3, $anio); ?></a></td>
					<td><?php echo sinActu($conexion, $id, 1, $anio) + sinActu($conexion, $id, 2, $anio) + sinActu($conexion, $id, 3, $anio); ?></td>
				<?php }
				if (($month == 1 || $month == 2 || $month == 3 || $month == 4) && ($mes2 == 4 || $mes2 == 5 || $mes2 == 6 || $mes2 == 7 || $mes2 == 8 || $mes2 == 9 || $mes2 == 10 || $mes2 == 11 || $mes2 == 12)) { ?>
					<td><a target="blank" target="blank" href="index.php?cot=1&id=<?php echo $id . '&mes=' . $anio . '-04&mes2=' . $anio . '-04'; ?>&est=0&sol=NULL"><?php echo sinActu($conexion, $id, 4, $anio); ?></a></td>
				<?php }
				if (($month == 1 || $month == 2 || $month == 3 || $month == 4 || $month == 5) && ($mes2 == 5 || $mes2 == 6 || $mes2 == 7 || $mes2 == 8 || $mes2 == 9 || $mes2 == 10 || $mes2 == 11 || $mes2 == 12)) { ?>
					<td><a target="blank" target="blank" href="index.php?cot=1&id=<?php echo $id . '&mes=' . $anio . '-05&mes2=' . $anio . '-05'; ?>&est=0&sol=NULL"><?php echo sinActu($conexion, $id, 5, $anio); ?></a></td>
				<?php }
				if (($month == 1 || $month == 2 || $month == 3 || $month == 4 || $month == 5 || $month == 6) && ($mes2 == 6 || $mes2 == 7 || $mes2 == 8 || $mes2 == 9 || $mes2 == 10 || $mes2 == 11 || $mes2 == 12)) { ?>
					<td><a target="blank" target="blank" href="index.php?cot=1&id=<?php echo $id . '&mes=' . $anio . '-06&mes2=' . $anio . '-06'; ?>&est=0&sol=NULL"><?php echo sinActu($conexion, $id, 6, $anio); ?></a></td>
					<td><?php echo sinActu($conexion, $id, 4, $anio) + sinActu($conexion, $id, 5, $anio) + sinActu($conexion, $id, 6, $anio); ?></td>
				<?php }
				if (($month == 1 || $month == 2 || $month == 3 || $month == 4 || $month == 5 || $month == 6  || $month == 7) && ($mes2 == 7 || $mes2 == 8 || $mes2 == 9 || $mes2 == 10 || $mes2 == 11 || $mes2 == 12)) { ?>
					<td><a target="blank" target="blank" href="index.php?cot=1&id=<?php echo $id . '&mes=' . $anio . '-07&mes2=' . $anio . '-07'; ?>&est=0&sol=NULL"><?php echo sinActu($conexion, $id, 7, $anio); ?></a></td>
				<?php }
				if (($month == 1 || $month == 2 || $month == 3 || $month == 4 || $month == 5 || $month == 6  || $month == 7 || $month == 8) && ($mes2 == 8 || $mes2 == 9 || $mes2 == 10 || $mes2 == 11 || $mes2 == 12)) { ?>
					<td><a target="blank" target="blank" href="index.php?cot=1&id=<?php echo $id . '&mes=' . $anio . '-08&mes2=' . $anio . '-08'; ?>&est=0&sol=NULL"><?php echo sinActu($conexion, $id, 8, $anio); ?></a></td>
				<?php }
				if (($month == 1 || $month == 2 || $month == 3 || $month == 4 || $month == 5 || $month == 6  || $month == 7 || $month == 8 || $month == 9) && ($mes2 == 9 || $mes2 == 10 || $mes2 == 11 || $mes2 == 12)) { ?>
					<td><a target="blank" target="blank" href="index.php?cot=1&id=<?php echo $id . '&mes=' . $anio . '-09&mes2=' . $anio . '-09'; ?>&est=0&sol=NULL"><?php echo sinActu($conexion, $id, 9, $anio); ?></a></td>
					<td><?php echo sinActu($conexion, $id, 7, $anio) + sinActu($conexion, $id, 8, $anio) + sinActu($conexion, $id, 9, $anio); ?></td>
				<?php }
				if ($mes2 == 10 || $mes2 == 11 || $mes2 == 12) { ?>
					<td><a target="blank" target="blank" href="index.php?cot=1&id=<?php echo $id . '&mes=' . $anio . '-10&mes2=' . $anio . '-10'; ?>&est=0&sol=NULL"><?php echo sinActu($conexion, $id, 10, $anio); ?></a></td>
					<?php if ($mes2 == 11 || $mes2 == 12) { ?>
						<td><a target="blank" target="blank" href="index.php?cot=1&id=<?php echo $id . '&mes=' . $anio . '-11&mes2=' . $anio . '-11'; ?>&est=0&sol=NULL"><?php echo sinActu($conexion, $id, 11, $anio); ?></a></td>
					<?php }
					if ($mes2 == 12) { ?>
						<td><a target="blank" target="blank" href="index.php?cot=1&id=<?php echo $id . '&mes=' . $anio . '-12&mes2=' . $anio . '-12'; ?>&est=0&sol=NULL"><?php echo sinActu($conexion, $id, 12, $anio); ?></a></td>
					<?php } ?> <td><?php echo sinActu($conexion, $id, 10, $anio) + sinActu($conexion, $id, 11, $anio) + sinActu($conexion, $id, 12, $anio); ?></td>
				<?php } ?>
				<td><?php $total = 0;
					for ($i = 1; $i <= 12; $i++) {
						$total += sinActu($conexion, $id, $i, $anio);
					}
					echo $total;
					?>
				</td>
			...
			<tr>
				<td colspan="2">TL COTIZACIONES</td>
				<?php if ($month == 1) { ?>
					<td><?php echo cotXMes($conexion, $id, 1, $anio); ?></td>
				<?php }
				if ($month == 1 || $month == 2) { ?>
					<td><?php echo cotXMes($conexion, $id, 2, $anio); ?></td>
				<?php }
				if ($month == 1 || $month == 2 || $month == 3) { ?>
					<td><?php echo cotXMes($conexion, $id, 3, $anio); ?></td>
					<td><?php echo (cotXMes($conexion, $id, 1, $anio) + cotXMes($conexion, $id, 2, $anio) + cotXMes($conexion, $id, 3, $anio)); ?></td>
				<?php }
				if (($month == 1 || $month == 2 || $month == 3 || $month == 4) && ($mes2 == 4 || $mes2 == 5 || $mes2 == 6 || $mes2 == 7 || $mes2 == 8 || $mes2 == 9 || $mes2 == 10 || $mes2 == 11 || $mes2 == 12)) { ?>
					<td><?php echo cotXMes($conexion, $id, 4, $anio); ?></td>
				<?php }
				if (($month == 1 || $month == 2 || $month == 3 || $month == 4 || $month == 5) && ($mes2 == 5 || $mes2 == 6 || $mes2 == 7 || $mes2 == 8 || $mes2 == 9 || $mes2 == 10 || $mes2 == 11 || $mes2 == 12)) { ?>
					<td><?php echo cotXMes($conexion, $id, 5, $anio); ?></td>
				<?php }
				if (($month == 1 || $month == 2 || $month == 3 || $month == 4 || $month == 5 || $month == 6) && ($mes2 == 6 || $mes2 == 7 || $mes2 == 8 || $mes2 == 9 || $mes2 == 10 || $mes2 == 11 || $mes2 == 12)) { ?>
					<td><?php echo cotXMes($conexion, $id, 6, $anio); ?></td>
					<td><?php echo (cotXMes($conexion, $id, 4, $anio) + cotXMes($conexion, $id, 5, $anio) + cotXMes($conexion, $id, 6, $anio)); ?></td>
				<?php }
				if (($month == 1 || $month == 2 || $month == 3 || $month == 4 || $month == 5 || $month == 6  || $month == 7) && ($mes2 == 7 || $mes2 == 8 || $mes2 == 9 || $mes2 == 10 || $mes2 == 11 || $mes2 == 12)) { ?>
					<td><?php echo cotXMes($conexion, $id, 7, $anio); ?></td>
				<?php }
				if (($month == 1 || $month == 2 || $month == 3 || $month == 4 || $month == 5 || $month == 6  || $month == 7 || $month == 8) && ($mes2 == 8 || $mes2 == 9 || $mes2 == 10 || $mes2 == 11 || $mes2 == 12)) { ?>
					<td><?php echo cotXMes($conexion, $id, 8, $anio); ?></td>
				<?php }
				if (($month == 1 || $month == 2 || $month == 3 || $month == 4 || $month == 5 || $month == 6  || $month == 7 || $month == 8 || $month == 9) && ($mes2 == 9 || $mes2 == 10 || $mes2 == 11 || $mes2 == 12)) { ?>
					<td><?php echo cotXMes($conexion, $id, 9, $anio); ?></td>
					<td><?php echo (cotXMes($conexion, $id, 7, $anio) + cotXMes($conexion, $id, 8, $anio) + cotXMes($conexion, $id, 9, $anio)); ?></td>
				<?php }
				if ($mes2 == 10 || $mes2 == 11 || $mes2 == 12) { ?>
					<td><?php echo cotXMes($conexion, $id, 10, $anio); ?></td>
					<?php if ($mes2 == 11 || $mes2 == 12) { ?>
						<td><?php echo cotXMes($conexion, $id, 11, $anio); ?></td>
					<?php }
					if ($mes2 == 12) { ?>
						<td><?php echo cotXMes($conexion, $id, 12, $anio); ?></td>
					<?php } ?>
					<td><?php echo (cotXMes($conexion, $id, 10, $anio) + cotXMes($conexion, $id, 11, $anio) + cotXMes($conexion, $id, 12, $anio)); ?></td>
				<?php } ?>
				<td>
					<?php
					echo $totalAnio;
				...
				<td>
					...
					$total2 = 0;
					if ($month != $mes2) {
						$total1 = $totalAnio / $month;
						$total2 = $totalAnio / $mes2;
						$totalc = round($total1 - $total2);
					} else {
						$totalc = round($totalAnio / ($mes2 - ($month - 1)));
					}
					echo $totalc;
					?>
				</td>
			...
			<tr class="bg-danger">
				<td colspan="2">EFICIENCIA <br>EN COTIZACIONES</td>
				<?php if ($month == 1) { ?>
					<td> %<?php echo porcentaje(estXMes($conexion, $id, 1, 2, $anio), cotXMes($conexion, $id, 1, $anio)); ?></td>
				<?php }
				if ($month == 1 || $month == 2) { ?>
					<td> %<?php echo porcentaje(estXMes($conexion, $id, 2, 2, $anio), cotXMes($conexion, $id, 2, $anio)); ?></td>
				<?php }
				if ($month == 1 || $month == 2 || $month == 3) { ?>
					<td> %<?php echo porcentaje(estXMes($conexion, $id, 3, 2, $anio), cotXMes($conexion, $id, 3, $anio)); ?></td>
				...
				<?php }
				if (($month == 1 || $month == 2 || $month == 3 || $month == 4) && ($mes2 == 4 || $mes2 == 5 || $mes2 == 6 || $mes2 == 7 || $mes2 == 8 || $mes2 == 9 || $mes2 == 10 || $mes2 == 11 || $mes2 == 12)) { ?>
					<td> %<?php echo porcentaje(estXMes($conexion, $id, 4, 2, $anio), cotXMes($conexion, $id, 4, $anio)); ?></td>
				<?php }
				if (($month == 1 || $month == 2 || $month == 3 || $month == 4 || $month == 5) && ($mes2 == 5 || $mes2 == 6 || $mes2 == 7 || $mes2 == 8 || $mes2 == 9 || $mes2 == 10 || $mes2 == 11 || $mes2 == 12)) { ?>
					<td> %<?php echo porcentaje(estXMes($conexion, $id, 5, 2, $anio), cotXMes($conexion, $id, 5, $anio)); ?></td>
				<?php }
				if (($month == 1 || $month == 2 || $month == 3 || $month == 4 || $month == 5 || $month == 6) && ($mes2 == 6 || $mes2 == 7 || $mes2 == 8 || $mes2 == 9 || $mes2 == 10 || $mes2 == 11 || $mes2 == 12)) { ?>
					<td> %<?php echo porcentaje(estXMes($conexion, $id, 6, 2, $anio), cotXMes($conexion, $id, 6, $anio)); ?></td>
					<td>% <?php echo porcentaje(
				...
				<?php }
				if (($month == 1 || $month == 2 || $month == 3 || $month == 4 || $month == 5 || $month == 6  || $month == 7) && ($mes2 == 7 || $mes2 == 8 || $mes2 == 9 || $mes2 == 10 || $mes2 == 11 || $mes2 == 12)) { ?>
					<td> %<?php echo porcentaje(estXMes($conexion, $id, 7, 2, $anio), cotXMes($conexion, $id, 7, $anio)); ?></td>
				<?php }
				if (($month == 1 || $month == 2 || $month == 3 || $month == 4 || $month == 5 || $month == 6  || $month == 7 || $month == 8) && ($mes2 == 8 || $mes2 == 9 || $mes2 == 10 || $mes2 == 11 || $mes2 == 12)) { ?>
					<td> %<?php echo porcentaje(estXMes($conexion, $id, 8, 2, $anio), cotXMes($conexion, $id, 8, $anio)); ?></td>
				<?php }
				if (($month == 1 || $month == 2 || $month == 3 || $month == 4 || $month == 5 || $month == 6  || $month == 7 || $month == 8 || $month == 9) && ($mes2 == 9 || $mes2 == 10 || $mes2 == 11 || $mes2 == 12)) { ?>
					<td> %<?php echo porcentaje(estXMes($conexion, $id, 9, 2, $anio), cotXMes($conexion, $id, 9, $anio)); ?></td>
					<td>% <?php echo porcentaje(
				...
				<?php }
				if ($mes2 == 10 || $mes2 == 11 || $mes2 == 12) { ?>
					<td> %<?php echo porcentaje(estXMes($conexion, $id, 10, 2, $anio), cotXMes($conexion, $id, 10, $anio)); ?></td>
					<?php if ($mes2 == 11 || $mes2 == 12) { ?>
						<td> %<?php echo porcentaje(estXMes($conexion, $id, 11, 2, $anio), cotXMes($conexion, $id, 11, $anio)); ?></td>
					<?php }
					if ($mes2 == 12) { ?>
						<td> %<?php echo porcentaje(estXMes($conexion, $id, 12, 2, $anio), cotXMes($conexion, $id, 12, $anio)); ?></td>
					<?php } ?>
					<td> % <?php echo porcentaje(
			...
			<tr>
				...
				<td> <?php echo "%" . porcentaje($totalc, $month); ?></td>
			</tr>

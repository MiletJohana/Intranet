...
$sqlEma="SELECT est.id_est, cli.nom_cli, sol.id_sol, cli.id_cli, sol.fec_sol, est.nom_est, sol.nom_atc , sol.obser_perm
FROM cre_estadosol est, mq_clientes cli,cre_solicitud sol
WHERE sol.id_est=est.id_est
...
$sqlsac="SELECT sol.id_sol, es.id_est ,es.nom_est, cli.id_cli, cli.nom_cli, sol.fec_sol, sol.nom_atc , sol.id_usu,sol.obser_perm
FROM cre_solicitud sol, cre_estadosol es, mq_clientes cli

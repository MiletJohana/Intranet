<?php 
    ...
    <table style="background-color:transparent;">
      <tr>
        <td width="100%" style="text-align:left; background-color:transparent;"> 
          <div id="project"  >
...
if(isset($cotizanteCoti) && (($cotizanteCoti['id_car']==3 &&  $cotizanteCoti['id_reg']==4) || ($cotizanteCoti['id_car']==9 && $cotizanteCoti['id_reg']==4))){
 $html2='
 <br>
 <br>
 <div>
 ...
 <table style="font-size:14px;font-style:Arial;">
 	<tr><td width="3%" style="background-color:transparent;" >
 		...
 		<td style="line-height:1.5;background-color:transparent;">
 			Notas:<br><br>
 			 <ul>
				<li>*Si el pedido es inferior a $400.000 se cobra el valor de transporte: $8000 +IVA</li>

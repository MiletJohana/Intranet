...
function verificarProd() {
    var isEmpty = false,
        ...
        marg_prod = document.getElementById('marg_prod').value;
    if (nom_pro === "") {
        alert("Debes Seleccionar un producto");
        isEmpty = true;
    } else if (und_emp === "") {
        alert("Debes ingresar un producto valido");
        isEmpty = true;
    } else if (can_com === "") {
        alert("Debes Poner una cantidad  valida");
        isEmpty = true;
    } else if (marg_prod == 0 || marg_prod == "") {
        alert("Selecciona un margen ");
        isEmpty = true;
    }
    return isEmpty;
}
...
function agregarProd() {
    if (!verificarProd()) {
        ...
        porcentaje = document.getElementById("porcet").value;
        ...
        cell8.innerHTML = porcentaje;
        cell9.innerHTML = can_com * pre_pro * can_emp;
        seleccionarProd();
        ...
        document.getElementById("marg_prod").value = "0";
    }
}
...
function seleccionarProd() {
    ...
    for (var i = 1; i < table.rows.length; i++) {
        table.rows[i].onclick = function() {
            ...
            // si se pide que muestre el margen 
...
function editarProd() {
    ...
    if (!verificarProd()) {
        ...
        table.rows[rIndex].cells[7].innerHTML = porcentaje;
        table.rows[rIndex].cells[8].innerHTML = can_com * pre_pro * can_emp;
    }

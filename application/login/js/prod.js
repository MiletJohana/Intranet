             ...
             function agregarProd() {
                 if (!verificarProd()) {
                     ...
                     cell5.innerHTML = pre_pro;
                     cell6.innerHTML = can_com;
                     cell7.innerHTML = can_com * pre_pro * can_emp;
                     seleccionarProd();
             ...
             function seleccionarProd() {
                 ...
                 for (var i = 1; i < table.rows.length; i++) {
                     table.rows[i].onclick = function() {
                         ...
                         document.getElementById("pre_pro").value = this.cells[4].innerHTML;
                         document.getElementById("can_com").value = this.cells[5].innerHTML;
             ...
             function editarProd() {
                 ...
                 if (!verificarProd()) {
                     ...
                     table.rows[rIndex].cells[4].innerHTML = pre_pro;
                     table.rows[rIndex].cells[5].innerHTML = can_com;
                     table.rows[rIndex].cells[6].innerHTML = can_com * pre_pro * can_emp;
                 }

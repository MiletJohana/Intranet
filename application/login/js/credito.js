            ...
            if (validarCampos('form-crm') == 0) {
                $.ajax({
                    ...
                    success: function(resp) {
                        ...
                        $('#modal-footer-sm').html('<a href="../credito/index.php" class="btn btn-default">Cerrar</a>');
                    }
                });
            }
        } else {
...
function confirmEliminarcrm(id_sol) {
    ...
    $.ajax({
        ...
        success: function(resp) {
            ...
            $('#smallModal').modal('show');
            $('#modal-footer-sm').html('<a class="btn btn-default" href="../credito/index.php" data-bs-dismiss="modal">Cerrar</a>');;
            $.ajax({
                url: '../credito/boton.php',
                type: 'POST',
                data: { resp: 4 },
    ...
    if (validarCampos('observa') == 0) {
        $.ajax({
            ...
            success: function(resp) {
                ...
                $('#smallModal').modal('show');
                $('#btn-footer-sm').html('<button type="button" class="btn btn-default" onclick="refreshTableCrm()" data-bs-dismiss="modal">Cerrar</button>');
                $('#btn-footer-sm').html('<a href="../credito/index.php" class="btn btn-default">Cerrar</a>');
                if (param == 3 || param == 4) {
                    if (param == 3) {
                        var resp1 = { resp: 8 };
                    } else if (param == 4) {

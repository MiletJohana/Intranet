    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-12 mb-3">
            ...
            <select class="form-select" id="tip_cot" name="tip_cot" required>
                ...
                <?php
                    $sqlTipCot = "SELECT * FROM cot_tip_cotizacion WHERE id_tip_cot IN(6,5,9,3)";
                ...
                <?php
                    $sqlTipCot = "SELECT * FROM cot_tip_cotizacion WHERE id_tip_cot IN($person->id_tip_cot,6,5,9,3)";
                    $queryTipCot = $conexion->query($sqlTipCot);
                }
    ...
    <div class="row">
        <div class="col-12 col-sm-12 mb-3">
            ...
            <div class="fileUpload btn btn-primary">
                <span id="document1">Seleccionar</span>
                ...
                <div>
                    <script type="text/javascript">
                        document.getElementById('docum').onchange = function() {
                            let archivoOpcion = validarSize('docum');
                            if(archivoOpcion == 1){
                                console.log(this.value);
                                document.getElementById('document1').innerHTML = document.getElementById('docum').files[0].name;
                            }
                            else{
                                alertWarningSize();

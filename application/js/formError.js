   ...
   $.fn.formError =
      function( message, options)
      {
         ...
         function show( options)
         {
            ...
            var errorDiv =
               $("<div class='validationErrorContainer' style='position:absolute; right:16px; top:-2px; z-index:99999;'>" +
                      "<div class='validationError'><i class='fa-solid fa-triangle-exclamation'></i>"+
                   "</div>" +
                 "</div>");
            ...
            $('#error-validation').html('<div class="alert alert-danger alert-dismissible fade show mt-4 d-flex align-items-center" style="font-size:15px;" role="alert"><i class="fa-solid fa-circle-exclamation me-3 fa-xl"></i>Los campos no pueden quedar vacios.</div>');
         }
      };

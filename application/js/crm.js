...
function ocultar(param, value) {
    if (value == 0) {
        ...
        $('#icon-hide-' + param).removeClass("fa-solid fa-eye-slash");
        $('#icon-hide-' + param).addClass("fa-solid fa-eye");
    } else {
        $('#' + param).removeAttr("style");
        $('#hide-' + param).attr("onclick", "ocultar('" + param + "', 0)");
        $('#icon-hide-' + param).removeClass("fa-solid fa-eye");
        $('#icon-hide-' + param).addClass("fa-solid fa-eye-slash");
    }
}
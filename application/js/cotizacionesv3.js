...
function eliminar(resp, elim, nom, conf) {
    if (conf == 1) {
        ...
        $.ajax({
            url: '../cotizadorv3/cotizaciones.controller.php',
            type: 'POST',
    ...
    if (validarCampos('form-productos') == 0) {
        ...
        $.ajax({
            ...
            success: function(data) {
                if(resp == 1){
                    $('#ProductosResp').html(data);
                    $('#error4').html('');
                } else {
                    alertSuccess('¡Se ha actualizado el producto correctamente!', '', 1);
                }
            }
        });
    } else {
        alertError('Verifica los campos vacíos');
    }
}
...
function buscarProd(param) {
    if (param == 1) {
        $('#input-nom_pro2').css('display', '');
        $('#nom_pro2').attr('onkeyup', 'autoProd(2)');
        $('#nom_pro2').focus();
        ...
        $('#cod_ref1').css("border", "");
        $('#nom_pro2').val('');
        $('#input-nom_pro2').css('display', 'none');
...
function actualizarTablaEstadisticas(id) {
    ...
    $.ajax({
        url: '../cotizadorv3/table_stadistics.php',
    ...
    $.ajax({
        ...
        success: function(resp) {
            if (resp != 1) {
                ...
                toastSuccess('Solicita actualizado correctamente');
            }
    ...
    $.ajax({
        ...
        success: function(resp) {
            if (resp != 1) {
                ...
                toastSuccess('Fecha de envío actualizada correctamente');
            }
        }
    ...
    $.ajax({
        ...
        success: function(resp) {
            if (resp != 1) {
                ...
                alertSuccess('Estado actualizado correctamente','', 1);
            }
    ...
    $.ajax({
        ...
        success: function(resp) {
            if (resp != 1) {
                ...
                toastSuccess('Comentario actualizado correctamente');
            }
        }
    ...
    $.ajax({
        ...
        success: function(resp) {
            if (resp != 1) {
                ...
                toastSuccess('Confirmación por actualizada correctamente');
            }
        }
    ...
    $.ajax({
        ...
        success: function(resp) {
            if (resp != 1) {
                ...
                toastSuccess('Razón actualizada correctamente');
            }
        }
    ...
    $.ajax({
        ...
        success: function(resp) {
            if (resp != 1) {
                ...
                toastSuccess('Llamadas actualizadas correctamente');
            }
        }
...
function actualizarEstadoCotizacion(state, opc) {
    ...
    switch (opc) {
        case 1:
            a.attr("class", "btn btn-secondary btn-circle btn-warning btn-sm");
            break;
        case 2:
            a.attr("class", "btn btn-secondary btn-circle btn-success btn-sm");
            break;
        case 3:
            a.attr("class", "btn btn-secondary btn-circle btn-danger btn-sm");
            break;
        case 4:
            a.attr("class", "btn btn-secondary btn-circle btn-info btn-sm");
            break;
    }
}
...
function ctrlUsu() {
    ...
    $.ajax({
        url: '../cotizadorv3/table_control.php',
        type: 'POST',
...
function ctrlResum() {
    ...
    $.ajax({
        url: '../cotizadorv3/tablacontrol.php',
        type: 'POST',
        data: { id, id_usu: id, mes, mes2 },
        success: function(resp) {
...
function cotUsu(actu, anio) {
    ...
    var est_cot = document.getElementsByName("est_cot")[0].value;
    var mes = document.getElementsByName("mes")[0].value;
    //alert(actu+','+anio+','+id_usu+','+est_cot+','+mes);
    if (actu < 10) {
        var actu = '0' + actu;
    }
    var mes2 = anio + '-' + actu;
...
function mostrarCoti() {
    var id_usu = document.getElementsByName("id_usu")[0].value;
    $.ajax({
        url: '../cotizadorv3/tablaTotal.php',
        data: { resp: 1 },
        type: 'POST',
        success: function(resp) {
            $('#content-table').html(resp);
...
function edit_prod(resp, edit, id_usu){
   
    var title = 'Actualizar Producto';
    $('#modal-title-lg').html(title);

    $.ajax({
        url: '../cotizadorv3/form5.php',
        type: 'POST',
        data: { resp, edit },
        success: function(respHtml) {
            $('#modal-body-lg').html(respHtml);
    ...
    $.ajax({
        ...
        success: function(resp) {
            $('#modal-footer-lg').html(resp);
            $('#cerrar9').attr('onclick', 'refreshTable(9)');
        }
    });
}
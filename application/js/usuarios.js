    ...
    if (validarCampos() == 0) {
        ...
        $.ajax({
            ...
            success: function(resp) {
                ...
                $('#modal-footer-sm').html('<button type="button" class="btn btn-secondary" onclick="refreshTableUsu()" data-bs-dismiss="modal">Cerrar</button>');
            }
        });
    }
}
    ...
    if (validarCampos() == 0) {
        ...
        $.ajax({
            ...
            success: function(resp) {
                ...
                $('#modal-body-sm').html(resp);
                $('#smallModal').modal('show');
                $('#modal-footer-sm').html('<button type="button" class="btn btn-secondary" onclick="location.reload()" data-bs-dismiss="modal">Cerrar</button>');
            }
        });
    }
}
...
function changeOptions() {
    var num_perfil = $("input[name='perfil_usu']:checked").val();

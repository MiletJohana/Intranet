...
include '../../resources/template/credentials.php';
	...
	$sql3="SELECT * FROM mq_clie cli, cre_solicitud sol
				 where cli.id_cli=sol.id_cli";
				 if(isset($_GET['id_sol']) && $_GET['id_sol']!=''){
					 $sql3.=" AND sol.id_sol=".$_GET['id_sol'];
    ...
    <main>
		...
		<div>
			...
			<br>
					...
					sido aprobada por '.$datosclie["num_letra"] . ' ('.($datosclie["cup_aut"]).') con un término de pago a '.$datosclie["term_auto"].'  días. 
					<br>
					<br>
				...
				<img src="https://intranet.masterquimica.com/resources/utils/phppdf/img/Firma-Nubia.png" width="29%" align="left"></td><br>
				<br>
				NUBIA MARTINEZ
				<br>
				Contadora 

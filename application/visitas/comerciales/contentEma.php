    ...
    <div style="margin-top: 3em;margin-bottom: 3em;margin-left: 7em;margin-right: 7em;">
        <div>
            <div>
                <div style="text-align: center; margin: 3em;">
                    <img style="width:15em;" src="https://intranet.masterquimica.com/resources/utils/phppdf/img/mastercasa.png">
                </div>
                <p>
        ...
        <table>
            <td width="40%" style="background-color:transparent;">
                <p>
                    <span style="font-weight:bold;">'.strtoupper(utf8_encode($com->nom_usu)).'</span><br>
